...
<!-- This is data table -->
<script src="/assets/js/admin/datatables.net/js/jquery.dataTables.min.js"></script>
<script src="/assets/js/admin/datatables.net-bs4/js/dataTables.responsive.min.js"></script>
