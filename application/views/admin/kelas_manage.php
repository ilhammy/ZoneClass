<div class="row page-titles">
	<div class="col-md-5 align-self-center">
		<h3 class="text-themecolor">Kelola Kelas</h3>
		<ol class="breadcrumb">
				...
				<div class="table-responsive mt-2">
					<table id="myTable" class="table table-bordered table-striped nowrap table-hover">
						...
						<tbody>
							...
							$yangpunya = $this->User_model->getProfile($val->creator_id, 'fullname');
							if ($val->creator_id == myUid()) $yangpunya = '<font class="text-primary">Saya</font>';
							?>
							<tr>
								...
								<td class="text-center">
									<button class="btn btn-sm btn-primary <?= ($val->creator_id === myUid()) ? '' : 'd-none'?>" onclick="window.location.href='/dashboard/kelas/<?= $val->id_kelas ?>'">
